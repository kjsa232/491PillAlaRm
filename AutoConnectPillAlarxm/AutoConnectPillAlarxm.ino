...
// definition of WiFiManager as global because unlike og I want it around
...
void setup() {
  ...
  //WiFiManager wifiManager; // except i do want it to be around
  ...
  wifiManager.autoConnect("PillAlarxmConnect", "password?"); //( name , Pass)
...
void connectionStatus()
{
 ...
 {
  case WL_CONNECTED:
    //send connected symbol
    mySerial.println('#');
    break;

  default:
    //send not connected symbol
    mySerial.println('!');
 }//end switch
